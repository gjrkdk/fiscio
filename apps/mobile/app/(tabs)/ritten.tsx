      ...
      <View style={styles.content}>
        <View style={styles.header}>
          ...
          <TouchableOpacity style={styles.button}>
            <Text style={styles.buttonText}>+ Rit</Text>
          </TouchableOpacity>
        </View>

        <View style={styles.empty}>
          <Text style={styles.emptyText}>Nog geen ritten geregistreerd</Text>
          <Text style={styles.emptyHint}>Druk op + Rit om een rit toe te voegen</Text>
        </View>
      </View>
    </SafeAreaView>
  )
